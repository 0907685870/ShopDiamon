	...
	<div class="row product-content">
		...
		<div class="span9">
			<ul class="breadcrumb">
				...
				<li><a href="<c:url value = "/san-pham/${ product.id_category }"/>">Items</a> <span class="divider">/</span></li>
			...
			<div class="well well-small">
				<div class="row-fluid">
					...
					<div class="span7">
						...
						<form class="form-horizontal qtyFrm" method = "get" acction = "c:url value = "/AddCart/${ product.id_product }">
							<div class="control-group">
								<label class="control-label"><span><fmt:formatNumber type = "number" groupingUsed = "true" value = "${product.price}" /></span>đ</label>
								<div class="controls">
						...
						<div class="row-fluid">
							...
							<div class="span4 alignR">
								<form class="form-horizontal qtyFrm">
									<h3><span><fmt:formatNumber type = "number" groupingUsed = "true" value = "${ item.price }" /></span>đ</h3>
									<br>
									<div class="btn-group">
