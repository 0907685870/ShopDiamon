...
-->
	<div class="row">
				...
				<table class="table table-bordered table-condensed">
					...
					<div class="text pull-right" >
						<span style="color: red;" >
							Tổng thanh toán : <fmt:formatNumber type="number" groupingUsed="true" value="${TotalPriceCart}"/>₫
						</span>
					</div>		
				</h3>
				</br>
		...
		<a href="<c:url value = "/trang-chu/"/>" class="shopBtn btn-large"><span
			...
			href="<c:url value = "/checkout"/>" class="shopBtn btn-large pull-right">Thanh toán
