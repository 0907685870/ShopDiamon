				...
				<div class="alignR">
					<div class="pull-left socialNw">
						<a href="#"><span class="icon-twitter"></span></a> <a
							href="https://www.facebook.com/"><span class="icon-facebook"></span></a>
						<a href="https://www.youtube.com/"> <span class="icon-youtube">
						</span>
					...
					<c:if test="${ not empty LoginInfor }">
						<a href="#"/>
							...
							</span>${LoginInfor.display_name}</a>
						<a href="<c:url value="dang-xuat" />"> <span class="icon-edit">
						</span> Đăng xuất</a>
					</c:if>
					...
					<a href="contact.html"><span class="icon-envelope"></span>
						...
						<span class="badge badge-warning"><fmt:formatNumber
								type="number" groupingUsed="true" value="${ TotalPriceCart }" /></span>đ</a>
				</div>
			</div>
		</div>
	</div>
